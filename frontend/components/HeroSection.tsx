    ...
    <div className="relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center min-h-screen">
      ...
      <div className="px-4 py-10 md:py-20">
        <h1 className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold text-slate-700 md:text-4xl lg:text-7xl dark:text-slate-300">
          {"Schedule emails with precision and reliability"
            .split(" ")
            .map((word, index) => (
              <motion.span
                key={index}
        ...
        >
          ReachInbox helps you schedule and send emails at scale with intelligent
          rate limiting, persistent queues, and reliable delivery tracking.
        </motion.p>
  ...
  return (
    <nav className="flex w-full items-center justify-between border-t border-b border-neutral-200 px-4 py-4 dark:border-neutral-800">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-base font-bold md:text-2xl">ReachInbox</h1>
      </div>
      <button
        onClick={onSignInClick}
